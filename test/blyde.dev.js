...
var init = function init() {
	...
	info('Blyde v' + "0.1.0-alpha.20.dev.bd03716" + ' initlized!');
};
...
var takeSnapshot = function takeSnapshot() {
	...
	return {
		version: 'Blyde v' + "0.1.0-alpha.20.dev.bd03716",
		methods: methodsShot,
		plugins: pluginShot,
		$node: $node,
		$nodeList: $nodeList,
